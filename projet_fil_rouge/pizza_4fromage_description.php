...
<head>
    ...
    <title>Pizza 4 fromage description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/pizza-4-fromage.webp" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pizza 4 fromage</h5>
                    <p class="card-text">Pâte à pizza 1, Mozzarella 1 boule, Gorgonzola 100 g, Tomme de savoie 100 g, Emmental 100 g, Coulis de tomate, Origan.<br>
                        Prix: 10.90 € </p>
