...
<head>
    ...
    <title>Burger bacon description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/burger_bacon.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Burger Bacon</h5>
                    <p class="card-text">Pain à hamburger 1, Steak haché 1, Bacon 2 tranches, Cheddar 1 tranche, Oignon rouge 0,5, Tomate 0,5, Salade 1 feuille, sel, Poivre, Sauce au choix.<br>
                        Prix: 10.90 € </p>
