...
<head>
    ...
    <title>Pâtes aux 3 fromages description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/pate_au_3_fromton.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pâtes aux 3 fromages</h5>
                    <p class="card-text">Penne 400 g, Emmenthal 80 g, Gorgonzola 70 g, Parmesan 30 g, Crème liquide 50 cl, Basilic 1 bouquet, Poivre.<br>
                        Prix: 19.90 € </p>
