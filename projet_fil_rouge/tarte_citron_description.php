...
<head>
    ...
    <title>Tarte au citron description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/tarte-au-citron.jpeg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Tarte au citron</h5>
                    <p class="card-text">Farine de blé 250 g, Beurre mou 100 g, Eau 100 ml, Sucre en poudre 50 g, Levure chimique 1 c. à café, Sel 2 pincée, 
                        Crème au citron, Meringue.<br>
                        Prix: 4.00 € </p>
