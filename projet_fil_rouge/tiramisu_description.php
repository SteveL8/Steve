...
<head>
    ...
    <title>Tiramisu description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Tiramisu.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Tiramisu</h5>
                    <p class="card-text">Boudoirs 1 paquets, Mascarpone 125 g, Oeufs 3, Sucre en poudre 3 c. à soupe, Café 0,5 bol, Cacao amer 50 g.<br>
                        Prix: 4.00 € </p>
