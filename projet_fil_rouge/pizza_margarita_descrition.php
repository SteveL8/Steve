...
<head>
    ...
    <title>Pizza margarita description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/pizza-margherita.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pizza margarita</h5>
                    <p class="card-text">Pâte à pizza 400 g,Purée de tomate 6 cuillère, Mozzarella 250 g, Basilic frais quelques feuilles, Huile d'olive 5 c. à soupe, 
                        Sel, Poivre.<br>
                        Prix: 11.00 € </p>
