...
<head>
    ...
    <title>Pâtes aux courgettes et pancetta  description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/pcp.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pâtes aux courgettes et pancetta </h5>
                    <p class="card-text">Pâtes 400 g, Pancetta 150 g, Petites courgettes 3, Jaunes d'oeufs 3, Crème fraîche épaisse 10 cl, Parmesan râpé 60 g,
                         Huile d'olive 2 c. à soupe, Sel, Poivre.<br>
                        Prix: 22.90 € </p>
