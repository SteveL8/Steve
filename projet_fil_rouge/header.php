<header>
  <nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
      <a href="index.php"><img src="img/logo.png" class="navbar-brand img-fluid rounded" alt="Logo" title="Logo" width="110" height="24"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="panier.php"><svg xmlns="http://www.w3.org/2000/svg" width="150" height="30" fill="currentColor" class="bi bi-basket me-5 link-dark icon-link" id="pa" viewBox="0 0 16 16">
