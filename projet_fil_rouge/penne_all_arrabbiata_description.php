...
<head>
    ...
    <title>Penne all'arrabbiata description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/penne-a-l-arrabiata.webp" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Penne all'arrabbiata</h5>
                    <p class="card-text">Penne 400 g, Piment oiseaus 2, Basilic frais 8 feuilles, Sel, Poivre, Sauce tomate 350 g, Ail 2 gousses, Huile d'olive 4 cl.<br>
                        Prix: 21.90 € </p>
