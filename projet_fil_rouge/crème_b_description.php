...
<head>
    ...
    <title>Crème brulée description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/creme-brulee-1200.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Crème brulée</h5>
                    <p class="card-text">Jaunes d'oeufs 5, Sucre 100 g, Crème fleurette 50 cl, Vanille 1 gousse, Vergeoise vrune 4 c. à café.<br>
                        Prix: 4.00 € </p>
