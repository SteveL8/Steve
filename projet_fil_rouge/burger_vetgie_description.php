...
<head>
    ...
    <title>Burger Vegetariens description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/burgers-vegetariens.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Burger Vegetariens</h5>
                    <p class="card-text">Ingrédients pour le steak de pois chiches : Oeuf 0,5, Oingon 0,5, Ail la moitier d'une gousse, Pois chiches 150 g, 
                        Huile d'olive 1,5 c. à soupe, Sel, Poivre.<br>Hamburger : Pain à hamburger 1, Steak de pois chiches 1, Salade 2 feuilles, Tomate 0,5,
                        Oignon 1, Fromage 1 tranche, Sauche au choix.<br>
                        Prix: 10.90 € </p>
