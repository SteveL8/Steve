...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/soba.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Soba</h5>
                    <p class="card-text">Nouille type soba 100 g, Petits champignons de Paris 80 g, Tofu ferme 280 g, Carotte 1, Poivron rouge 1, Cébettes 3, 
                        Sauce soja 25 ml, Gingembre frais 15 g, mirin 1, Pàates miso, Graines de sésame 5 g, Maizena 1, Coriandre moulue 1/2,
                        Gingembre en poudre 1/2, Piment doux en poudre 1/2, Huile , Sel, Poivre. <br>
                        Prix: 18.00 € </p>
