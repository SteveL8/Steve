...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/maki-sushi.jpeg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Maki</h5>
                    <p class="card-text">Riz à sushi 500 g, Eau 550 ml, Vinaigre de riz 70 g, Nori 3 feuilles, Wasabi, 
                        Saumonfrais 600 g, Sucre 25 g, Avocats 2, Sauce soja, Sel fin 10g<br>
                        Prix: 05.90 € </p>
