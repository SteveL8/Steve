...
<head>
    ...
    <title>Burger poulet et avocat description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/burger-au-poulet-et-avocat.jpeg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Burger au Poulet et Avocat</h5>
                    <p class="card-text">Pain à hamburger 1, Blanc de poulet 1, Ciboulette 1 botte, Philadelphia 15 g, Oignon 1, Sel, Poivre, Avocat 1, Citron vert,
                        Sauce au choix.<br>
                        Prix: 10.90 € </p>
