...
<head>
    ...
    <title>Millefeuille description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/millefeui.avif" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Millefeuille</h5>
                    <p class="card-text">Fraises 55 g, Feuille filo 9, Sucre 75 g, Lait 0.5 l, Jaune d'oeufs 3, Sucre glace 4 c. à soupe, Beuure fondu 20, Farine 1 c. à soupe.<br>
                        Prix: 4.00 € </p>
