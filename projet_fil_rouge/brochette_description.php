...
<head>
    ...
    <title>Brochette description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Brochette.webp" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Brochette </h5>
                    <p class="card-text">Poulet haché 500 g, Sucre 2 c. à café, Sauce soja 20 c. à soupe, Jaune d'oeuf 2, Chapelure 6 c. à café, Piques à Brochettes en bois 8.<br>
                        Prix: 09.90 € </p>
