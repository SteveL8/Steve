...
<head>
    ...
    <title>Coca-cola description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Coca-Cola.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Coca cola</h5>
                    <p class="card-text">Sucre 14 kg, 7,6 Litre d'eau, JUs de lime 950 ml, Citrate de cafeine 110 g, Acide citrique 57 g, Extrait de vanille 30 ml, 
                        Extrait fluide de noix de kola 22 ml, Extrait fluide de feuille de coca 22 ml.<br>
                        Prix: 1.50 € </p>
