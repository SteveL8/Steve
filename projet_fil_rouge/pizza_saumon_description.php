...
<head>
    ...
    <title>Pizza Saumon description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/pizza-salmon.png" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pizza saumon</h5>
                    <p class="card-text">Pâte à pizza 400 g, Origan, Huile d'olive 5 c. à soupe, 6 tranche fine de saumon, crème fraiche épaisse, 
                        2 Boules de mozzarella, Citron 1/2.<br>
                        Prix: 11.50 € </p>
