...
<head>
    ...
    <title>Pâtes au pesto description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Pates-au-pesto.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pâtes au pesto</h5>
                    <p class="card-text">Linguine 160 g, Sauce pesto 85 ml, Huile d'olive extra vierge 15 ml, Sel 1 pincée.<br>
                        Prix: 18.90 € </p>
