...
<head>
    ...
    <title>Pâtes au poulet, béchamel et champignons description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/pates-poulet-bechamel-et-champignons.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pâtes au poulet, béchamel et champignons</h5>
                    <p class="card-text">Pâtes 200 g, Blancs de poulet 2 blancs, Champignons émincés 1 boite, Oignon 1, Gruyère râpé 100 g, Farine 80 g, Lait 1 litre.<br>
                        Prix: 21.90 € </p>
