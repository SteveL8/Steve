...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Ramen.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Ramen</h5>
                    <p class="card-text">Nouille ramen 200 g, Oeufs 2, Ciboule 2, Sauce soja 4 c. à soupe, Graines de sésame 4 c. à café, 
                        Escalopes 2, Gousses d'ail 2, Bouillon de volaille 2 cubes, Huile de sésame 2 c. à soupe, Mirin 3 c. à soupe.<br>
                        Prix: 24.00 € </p>
