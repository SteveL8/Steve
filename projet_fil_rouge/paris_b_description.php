...
<head>
    ...
    <title>Paris brest description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Paris-Bre.JPG" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Paris brest</h5>
                    <p class="card-text">Lait 180 ml, Beurre 155 g, Farine 65 g, Oeufs 3, Sucre 50 g, Fécule de maïs 25 g, Goussets de vanille 0.5, 
                        Cassonade blonde 25 g.<br>
                        Prix: 4.00 € </p>
