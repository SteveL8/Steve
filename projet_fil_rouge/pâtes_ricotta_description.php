...
<head>
    ...
    <title>Pâtes ricotta description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Pâtesricotta.jpeg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Pâtes ricotta </h5>
                    <p class="card-text">Pâtes 500 g, Crème fraiche 3 c. à soupe, Gros sel, Ricotta 1 pot, Gruyère râpé 100 g.<br>
                        Prix: 19.90 € </p>
