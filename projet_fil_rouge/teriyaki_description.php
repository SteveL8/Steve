...
<head>
    ...
    <title>Toriyaki description</title>
</head>
...
<body>
    ...
    <div class="container d-flex justify-content-center  align-items-center card border-dark rounded-4 mt-3 mb-5" style="max-width: 1600px;">
        <div class="row g-0">
            <div class="col-sm-4">
                <img src="img/Recette-Poulet-Teriyaki.jpg" class="img-fluid rounded-4 my-3" alt="pizza-margarita" title="pizza-margarita" style="width: 1000px;">
            </div>
            <div class="col-sm-8">
                <div class="card-body">
                    <h5 class="card-title">Poulet Teriyaki</h5>
                    <p class="card-text">Poulet 250 g, Huile de sésame 3 c. à soupe, Vinaigre 1 c. à soupe, sucre 1 c. à café, Sauce de soja 3 c. à soupe,
                        Saké 1 c. à soupe, Jus de gingenbre 1 c. à café.<br>
                        Prix: 29.00 € </p>
